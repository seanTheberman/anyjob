...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (
      session.metadata?.type !== "buyer_plan_subscription" ||
      !userId ||
      !planId ||
    ...
    const plan = getBuyerPlanById(rules, planId);
    ...
    console.error("Buyer plan checkout confirmation failed:", error);
